...
const insertUser = async (req, res) => {
    ...
    await check("email").notEmpty().withMessage("El correo es obligatorio").isEmail().withMessage("Ese no es un formato valido").run(req) // Express checa que el email no venga vacio
